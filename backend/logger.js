...
const upstreamHosts = new signale.Signale({ scope: "Upstream ", ...opts });
...
export { debug, global, migrate, express, access, nginx, ssl, certbot, importer, setup, ipRanges, remoteVersion, upstreamHosts };
