...
- **`IP_RANGES_FETCH_ENABLED`**  
  - Controls fetching of CloudFront & Cloudflare IP ranges
...
- **`EO_IP_RANGES_FETCH_ENABLED`**  
  - Controls fetching of EdgeOne IP ranges
...
Note: For EdgeOne, further config and credentials are required (see next section).
