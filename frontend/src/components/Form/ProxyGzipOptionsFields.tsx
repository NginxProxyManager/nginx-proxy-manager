...
export function ProxyGzipOptionsFields({ color = "bg-cyan" }: Props) {
	const { values, setFieldValue } = useFormikContext<FormValues>();
	const { gzipCompLevel, gzipEnabled, gzipTypes } = values;

	const handleGzipTypesChange = (selected: MultiValue<SelectOption>, _actionMeta: ActionMeta<SelectOption>) => {
		setFieldValue(
			"gzipTypes",
	...
	const toggleRow = (name: "gzipEnabled", label: string, enabled: boolean) => (
		<div>
