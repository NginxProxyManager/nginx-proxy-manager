...
HTTP валидираният сертификат означава, че сървърите на Certbot ще се опитат да достигнат вашите домейни по HTTP (не по HTTPS!) и ако успеят, ще издадат сертификата.
...
DNS валидираният сертификат изисква използването на DNS Provider плъгин. Този DNS Provider ще бъде използван за временно създаване на записи във вашия домейн, след което Certbot ще ги провери, за да се увери, че сте собственикът, и при успех ще издаде сертификата.
...
Използвайте тази опция, за да качите собствен TLS сертификат, предоставен от ваша сертификатна агенция.
